...
`opensource projects <http://polib.rtfd.org/en/latest/projects.html>`_.

The project code and bugtracker is hosted on 
`Bitbucket <http://bitbucket.org/izi/polib/>`_. 

polib is generously documented, you can `browse the documentation online 
<http://polib.rtfd.org/>`_, a good start is to read 
`the quickstart guide  <http://polib.rtfd.org/en/latest/quickstart.html>`_.
